...
@ApiModel(value="冻结审核记录模型")
@Table(name = "freeze_audit_records")
public class FreezeAuditRecords implements Serializable {
    ...
    private String id;
	    ...
	    //业主电话
	@ApiModelProperty(value="业主电话" ,required=true)
