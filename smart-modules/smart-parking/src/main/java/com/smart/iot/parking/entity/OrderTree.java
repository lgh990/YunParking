 ...
 */
public class OrderTree extends TreeNodeVO<ParkingOrders> {
...
*/
	...
	//流程id
	@MergeField(feign = ParkingBusinessTypeBiz.class,method = "getEntityByIds",isValueNeedMerge = true)
	@Column(name = "parking_bus_type")
	private String parkingBusType;

	//停车场id
	@MergeField(feign = ParkingBiz.class,method = "getEntityByIds",isValueNeedMerge = true)
	...
	//车牌id
	@MergeField(feign = PlateBiz.class,method = "getEntityByIds",isValueNeedMerge = true)
	@Column(name = "pla_id")
	...
	//车位id
	@MergeField(feign = ParkingSpaceBiz.class,method = "getEntityByIds",isValueNeedMerge = true)
...
*/
	...
	public OrderTree(String orderId, String beginDate, String endDate, String reverseDate, String chargeRulesTypeId, String lmId, String lpId, String orderStatus, String orderType, String privateUserId, String parkingBusType, String parkingId, String parkingLongTime, String plaId, BigDecimal realMoney, String orderNum, String orderNumMd5, String spaceId, String udId, String  userId, String chargeId,String chargeDate, String platenumImage, String payStatus, String payType, String position, String createOrderType, String errorType, BigDecimal monthCardPrice, int monthCount,String parentId) {
		this.id = orderId;
